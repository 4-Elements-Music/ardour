/* audio-validator: sandboxed audio decoder sidecar for the audio_region_add MCP tool.
 * Reads <input>, validates geometry, transcodes to canonical 32-bit-float WAV at <output>,
